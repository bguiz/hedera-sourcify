...
| `UI_DOMAIN_NAME`              | example.com                     | Comma-separated list of fully qualified domain names of the hosts (running the ui or the mirror-node explorer) which are allowed origins for using the session API |
